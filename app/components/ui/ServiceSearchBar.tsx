...
const servicesList: ServiceItem[] = [
  ...
  },
  {
    id: "healing",
    title: "Healing",
    shortTitle: "Healing Services",
    icon: "🌿",
    href: "/services/healing",
    description: "Holistic emotional healing, self-discovery & inner resilience",
    keywords: ["healing", "inner peace", "mindfulness", "trauma", "self-discovery", "recovery"],
  },
  {
    id: "training",
    title: "Training",
